...
<div style="margin-top: 20px" class="container">
    ...
    <h1 class="center">Undergraduate Projects with PI Info Page</h1>
    ...
    <div class="topnav">
        ...
        <a class="active" href="ug-pi-proj.php">UG Student Proj w/ PI</a>
    ...
    displayTable("UG_Student_PI_Project");
    ?>
