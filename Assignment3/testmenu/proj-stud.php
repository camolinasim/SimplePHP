...
<div style="margin-top: 20px" class="container">
    ...
    <h1 class="center">Projects and Student Information Page</h1>
    ...
    <div class="topnav">
        ...
        <a class="active" href="proj-stud.php">Proj and Student</a>
    ...
    displayTable("which_students_are_registered_for_which_projects");
    ?>
