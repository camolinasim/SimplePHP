...
<body>
  <div style="margin-top: 20px" class="container">
    <h1 style='text-align:center;'>Doing Business</h1>
    <h2>User Login</h2>
...
if (!empty($_POST)) {
  if (isset($_POST['Submit'])) {
    ...
    $queryUser = "SELECT * FROM User WHERE username='" . $input_username . "' AND password='" . $input_password . "';";
    ...
    if ($resultUser->num_rows > 0) {
      ...
      header("Location: testmenu/user-menu.php");
    } else {
      echo "User not found.";
    }
    die();
